          ...
          <div className="embla__container flex h-full">
            {heroSlides.map((slide) => (
              ...
              >
                ...
                {/* Content */}
                <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 h-full flex items-center py-[20px] sm:py-[30px] md:py-[40px]">
